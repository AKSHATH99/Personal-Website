  ...
  return (
    <div id="project" className="md:ml-[100px] text-white px-4 sm:px-6 lg:px-8">
      ...
      <motion.div
        ...
        className="max-w-4xl"
      >
        <h1 className="text-white text-2xl sm:text-3xl md:text-2xl lg:text-3xl font-bold mt-20 pt-7">
          Things I've Built.
        </h1>
        <div className="w-32 h-1 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full mt-2 mb-4"></div>
        <p className="mt-5 text-sm sm:text-base text-gray-300 max-w-2xl">
        ...
        {ProjectData.map((data, index) => (
          ...
          >
            ...
            <div className="relative overflow-hidden">
              ...
              <div className="absolute top-2 sm:top-3 right-2 sm:right-3 flex space-x-1 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
                <motion.a
                  href={data.Livelink}
                  target="_blank"
            ...
            <div className="p-3 sm:p-4 bg-white/5 backdrop-blur-md border-t border-white/10 rounded-b-lg">
              {/* Title */}
              <motion.h3
                className="text-base sm:text-lg font-bold text-white mb-2 group-hover:text-blue-300 transition-colors duration-300 line-clamp-1"
                whileHover={{ x: 5 }}
              ...
              <div className="flex flex-wrap gap-1 mb-3">
                {data.stack.filter(Boolean).map((tech, techIndex) => (
                  <motion.div
                    key={techIndex}
                    className="relative group/tech bg-gray-800/60 rounded-full p-1 border border-gray-600/30 hover:border-blue-400/50 transition-all duration-300"
                  ...
                  >
                    ...
                    />
                    <div className="absolute inset-0 bg-blue-400/20 rounded-full opacity-0 group-hover/tech:opacity-100 transition-opacity duration-300" />
                  </motion.div>
                ))}
              </div>
            </div>
