        ...
        <div className="md:flex md:justify-center md:items-center mt-44">
          ...
          <div className="m-2 md:w-2/3 text-center md:text-left">
            ...
            <p className="w-full md:w-96 my-3 md:text-lg italic">
              ...
              aspects of creating responsive and user-friendly websites. Now I am
              looking for more experience in my field."
            </p>
            <div className="flex justify-center md:justify-start">
             <a href="https://www.linkedin.com/in/akshath-p-519939287/" target="blank"> <img
                alt="linkedin-icon"
                className="m-4 h-12 w-12"
                src="/images/linkedin-orange.png"
              /></a>
              <a href="https://github.com/AKSHATH99" target="blank"><img
                alt="git-icon"
                className="m-4 h-10 w-10 mt-5"
                src="/images/git-orange.png"
              /></a> 
             <a href="https://twitter.com/AkshathP2" target="blank"><img
                alt="icon"
