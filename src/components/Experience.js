  ...
  return (
    <section id="experience" className="py-8 relative">
      <div className="lg:ml-[190px] px-4 sm:px-6 relative">
        ...
        <div className="absolute left-10 top-[90px] flex flex-col items-center mt-5">
          <span className="mb-2 text-violet-400 font-semibold text-sm">
            Present
          </span>
          ...
          {experiences.map((exp, index) => (
            <div key={index} className="relative">
              ...
              {index !== experiences.length - 1 && (
                <div className="absolute left-10 -bottom-12 flex justify-center">
                  <div className="w-[2px] h-12 bg-violet-400"></div>
                </div>
              )}
            </div>
          ))}
